    ...
    <main className={`${styles.page} ${theme.page}`}>
      ...
      <section className={styles.hero} aria-labelledby="story-title">
        ...
        <div className={`${styles.intro} ${theme.intro}`}>
          ...
          <p className={styles.externalLink}><a href="https://s.kyarapu.com/s/6aa421dffd230e4c7a2ade11" target="_blank" rel="noreferrer" aria-label="キャラぷで「波打ち際、現行犯。」を開く（新しいタブ）">キャラぷで作品を開く <span aria-hidden="true">↗</span></a></p>
          {story.map((paragraph) => (
