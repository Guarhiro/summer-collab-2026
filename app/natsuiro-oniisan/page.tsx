    ...
    <main className={`${styles.page} ${theme.page}`}>
      ...
      <section className={styles.hero} aria-labelledby="story-title">
        ...
        <div className={styles.intro}>
          ...
          <p className={styles.externalLink}><a href="https://s.kyarapu.com/s/6a8cd6829ebd11cc54f2a672" target="_blank" rel="noreferrer" aria-label="キャラぷで「夏色お兄さんが今日もかわいい」を開く（新しいタブ）">キャラぷで作品を開く <span aria-hidden="true">↗</span></a></p>
